...
var options = {
  ...
  theme_path: 'www/themes/serundeputy',
  // Patterns for PHP files to lint and check.
  phpCheck: ['www/{modules,themes}/custom/**/*.{php,inc,module,theme,inc,install}'],
  // Patterns for JS files to lint and check.
  jsCheck: [
    'gulpfile.js',
    'gulpconfig.js',
    'www/{modules,themes}/custom/**/*.js',
    '!www/{modules,themes}/custom/**/bower_components/**',
    '!www/{modules,themes}/custom/**/node_modules/**',
    '!www/{modules,themes}/custom/**/dist/**'
  ],
  sass_rules: {
